...
def Generate_Brain():
    ...
    pyrosim.Send_Synapse(sourceNeuronName=1, targetNeuronName=3, weight=-50)
    pyrosim.Send_Synapse(sourceNeuronName=1, targetNeuronName=3, weight=21)

    pyrosim.Send_Synapse(sourceNeuronName=2, targetNeuronName=4, weight=50)
